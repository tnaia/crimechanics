...
SDL_Color textColor = { 0xC0, 0x0D, 0x0D };
...
bool init()
{
    ...
    SDL_WM_SetCaption( "(capped) Frame Rate Test", NULL );
...
bool load_files()
{
    ...
    //Open the font
    font = TTF_OpenFont( "../../media/lazy.ttf", 50 );
...
int main( int argc, char *args[] )
{
  ...
  //Keep track of the furrent frame
  int frame = 0;

  //Whether or not to cap the frame rate
  bool cap = true;

  //The trame rate regulator
  Timer fps;

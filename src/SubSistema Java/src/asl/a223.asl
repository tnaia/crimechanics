// Agent a223 in project Agents_tcc.mas2j
...
/* Plans */
+!negociar(Agente,Valor):Valor>500<-aceitarPropina(Agente).
+!negociar(Agente,Valor):Valor<500&Valor>300<-pedirMais(Agente).
+!negociar(Agente,Valor):Valor<300<-rejeitarPropina(Agente).
...
+estimulo(falaTimida):personalidade(rabugento)&estadoPsicologico(zangado)<-removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(rabugento)&estadoPsicologico(apreensivo)<-removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(rabugento)&estadoPsicologico(lisonjeado)<-atualizarEP(zangado);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(rabugento)&estadoPsicologico(compreensivo)<-removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(simpatico)&estadoPsicologico(feliz)<-atualizarEP(compreensivo);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(simpatico)&estadoPsicologico(zangado)<-removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(simpatico)&estadoPsicologico(apreensivo)<-removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(simpatico)&estadoPsicologico(lisonjeado)<-atualizarEP(compreensivo);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(simpatico)&estadoPsicologico(compreensivo)<-removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(educado)&estadoPsicologico(feliz)<-removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(educado)&estadoPsicologico(zangado)<-atualizarEP(compreensivo);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(educado)&estadoPsicologico(apreensivo)<-removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(educado)&estadoPsicologico(lisonjeado)<-atualizarEP(compreensivo);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(educado)&estadoPsicologico(compreensivo)<-removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(grosseiro)&estadoPsicologico(feliz)<-atualizarEP(zangado);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(grosseiro)&estadoPsicologico(zangado)<-removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(grosseiro)&estadoPsicologico(apreensivo)<-atualizarEP(zangado);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(grosseiro)&estadoPsicologico(lisonjeado)<-atualizarEP(zangado);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(grosseiro)&estadoPsicologico(compreensivo)<-atualizarEP(zangado);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(apressado)&estadoPsicologico(feliz)<-atualizarEP(zangado);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(apressado)&estadoPsicologico(zangado)<-removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(apressado)&estadoPsicologico(apreensivo)<-atualizarEP(zangado);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(apressado)&estadoPsicologico(lisonjeado)<-atualizarEP(zangado);removerEstimulo(falaTimida).
+estimulo(falaTimida):personalidade(apressado)&estadoPsicologico(compreensivo)<-atualizarEP(zangado);removerEstimulo(falaTimida).
...
+estimulo(inquisitivo):personalidade(rabugento)&estadoPsicologico(apreensivo)<-removerEstimulo(inquisitivo).
+estimulo(inquisitivo):personalidade(rabugento)&estadoPsicologico(lisonjeado)<-atualizarEP(zangado);removerEstimulo(inquisitivo).
...
+estimulo(inquisitivo):personalidade(simpatico)&estadoPsicologico(feliz)<-atualizarEP(apreensivo);removerEstimulo(inquisitivo).
+estimulo(inquisitivo):personalidade(simpatico)&estadoPsicologico(zangado)<-atualizarP(grosseiro);removerEstimulo(inquisitivo).
+estimulo(inquisitivo):personalidade(simpatico)&estadoPsicologico(apreensivo)<-atualizarP(grosseiro);removerEstimulo(inquisitivo).
...
+estimulo(inquisitivo):personalidade(educado)&estadoPsicologico(feliz)<-atualizarEP(zangado);removerEstimulo(inquisitivo).
+estimulo(inquisitivo):personalidade(educado)&estadoPsicologico(zangado)<-atualizarP(grosseiro);removerEstimulo(inquisitivo).
+estimulo(inquisitivo):personalidade(educado)&estadoPsicologico(apreensivo)<-removerEstimulo(inquisitivo).
...
+estimulo(inquisitivo):personalidade(grosseiro)&estadoPsicologico(feliz)<-atualizarEP(zangado);removerEstimulo(inquisitivo).
+estimulo(inquisitivo):personalidade(grosseiro)&estadoPsicologico(zangado)<-removerEstimulo(inquisitivo).
+estimulo(inquisitivo):personalidade(grosseiro)&estadoPsicologico(apreensivo)<-removerEstimulo(inquisitivo).
+estimulo(inquisitivo):personalidade(grosseiro)&estadoPsicologico(lisonjeado)<-atualizarEP(zangado);removerEstimulo(inquisitivo).
...
+estimulo(suspeito):personalidade(simpatico)&estadoPsicologico(zangado)<-atualizarP(grosseiro);removerEstimulo(suspeito).
...
+estimulo(suspeito):personalidade(educado)&estadoPsicologico(zangado)<-atualizarP(grosseiro);removerEstimulo(suspeito).
+estimulo(suspeito):personalidade(educado)&estadoPsicologico(apreensivo)<-removerEstimulo(suspeito).
...
+estimulo(suspeito):personalidade(grosseiro)&estadoPsicologico(zangado)<-removerEstimulo(suspeito).
...
+estimulo(suspeito):personalidade(apressado)&estadoPsicologico(zangado)<-removerEstimulo(suspeito).
...
+estimulo(inquestionavel):personalidade(rabugento)&estadoPsicologico(feliz)<-atualizarP(simpatico);removerEstimulo(inquestionavel).
+estimulo(inquestionavel):personalidade(rabugento)&estadoPsicologico(zangado)<-atualizarEP(compreensivo);removerEstimulo(inquestionavel).
...
+estimulo(inquestionavel):personalidade(rabugento)&estadoPsicologico(compreensivo)<-atualizarP(simpatico);removerEstimulo(inquestionavel).
...
+estimulo(inquestionavel):personalidade(grosseiro)&estadoPsicologico(compreensivo)<-atualizarP(educado);removerEstimulo(inquestionavel).
...
+estimulo(inquestionavel):personalidade(apressado)&estadoPsicologico(compreensivo)<-removerEstimulo(inquestionavel).

+started <- startPolicial.
...
+subornado(Agente):indole(corrupto)<-!negociar(Agente,Valor).
+subornado(Agente):indole(integro)<-prender(Agente).

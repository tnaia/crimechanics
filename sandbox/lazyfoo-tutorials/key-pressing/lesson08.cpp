...
int main( int argc, char* args[] )
{
    ...
    while( quit == false )
    {
		...
		// Habilitar a instrução abaixo permite ver que os
		// eventos são postos em uma fila: rode o programa 
		// e pressione mais de uma tecla em menos de dois 
		// segundos: o programa lembrará da segunda tecla.
		//	    SDL_Delay ( 2000 );
            }
